...
#subjects have both T1 and T2 files 
...
#read and get mask data for the subject from deep learning algoruthm 
...
for i in range(begin_volume,int(bold_data.shape[3])):  #iterate through all the volumes - only use one echo
